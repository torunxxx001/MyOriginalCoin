# Support for Output Descriptors in MyOriginalCoin Core

Since MyOriginalCoin Core v0.17, there is support for Output Descriptors in the
...
on MyOriginalCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing MyOriginalCoin Core wallets, a convenience function `combo` is
