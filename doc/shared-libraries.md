...
The purpose of this library is to make the verification functionality that is critical to MyOriginalCoin's consensus available to other applications, e.g. to language bindings.
...
- [NMyOriginalCoin](https://github.com/NicolasDorier/NMyOriginalCoin/blob/master/NMyOriginalCoin/Script.cs#L814) (.NET Bindings)
