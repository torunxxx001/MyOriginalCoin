...
The headless daemon `myoriginalcoind` has the JSON-RPC API enabled by default, the GUI
`myoriginalcoin-qt` has it disabled by default. This can be changed with the `-server`
