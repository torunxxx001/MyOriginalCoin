MyOriginalCoin Core version *0.15.2* is now available from:

  <https://github.com/torunxxx001/bin/bitcoin-core-0.15.2/>
...
MyOriginalCoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #11554 `a69cc07` Sanity-check script sizes in myoriginalcoin-tx (TheBlueMatt)
