MyOriginalCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/MyOriginalCoin/bitcoin-0.5.4/
...
http://gitorious.org/bitcoin/myoriginalcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix MyOriginalCoin-Qt notifications under Growl 1.3.
Increase required age of MyOriginalCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMyOriginalCoin properly when installing MyOriginalCoin-Qt over it. (Windows)
