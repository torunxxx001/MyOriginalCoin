MyOriginalCoin Core version 0.16.1 is now available from:

  <https://github.com/torunxxx001/bin/bitcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting myoriginalcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure myoriginalcoind processes are cleaned up when tests end (sdaftuar)
