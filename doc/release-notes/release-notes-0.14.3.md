MyOriginalCoin Core version *0.14.3* is now available from:
...
Since 0.14.0 the approximate transaction fee shown in MyOriginalCoin-Qt when using coin
...
- #10451 `3612219` contrib/init/myoriginalcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
