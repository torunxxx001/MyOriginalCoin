Download URL: https://sourceforge.net/projects/bitcoin/files/MyOriginalCoin/bitcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MORGC fee schedule (users still pay 0.01 MORGC per kb, until next version)
