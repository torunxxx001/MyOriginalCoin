MyOriginalCoin Core version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer MORGC/kB fee to be
...
Block pruning allows MyOriginalCoin Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that MyOriginalCoin Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only MyOriginalCoinAmountField
...
- #5809 `46bfbe7` Add myoriginalcoin-cli man page
...
- #5849 `41259ca` contrib/init/myoriginalcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename MyOriginalCoin-Qt.app to MyOriginalCoin-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for myoriginalcoin-tx)
