MyOriginalCoin Core version 0.13.1 is now available from:
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming MyOriginalCoin wallet
  software more difficult and which seriously complicates the design of smart
  contracts for MyOriginalCoin.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each MyOriginalCoin block need to be stored by nodes in order to validate future
...
- **Increased security for multisig:** MyOriginalCoin addresses (both P2PKH addresses
  ...
  believed to be provided by MyOriginalCoin's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  MyOriginalCoin paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of MyOriginalCoin's current ledger (called the UTXO set),
  ...
  note that MyOriginalCoin Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  MyOriginalCoin users to individually opt-in to almost any change in the MyOriginalCoin
  Script language when those users receive new transactions.  Features
  currently being researched by MyOriginalCoin Core contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other MyOriginalCoin community members are studying several other improvements
...
[Segwit FAQ]: https://github.com/torunxxx001/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://github.com/torunxxx001/en/segwit_wallet_dev/
[BIP141]: https://github.com/bitcoin/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/bitcoin/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/bitcoin/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/bitcoin/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://github.com/torunxxx001/en/2016/06/08/version-bits-miners-faq/
...
Since MyOriginalCoin Core 0.10.0, nodes have defaulted to only relaying and
...
- #8829 `2a8bca4` Add myoriginalcoin-tx JSON tests (jnewbery)
...
- #8860 `0bee740` util: Move wait_myoriginalcoinds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update myoriginalcoin-tx to output witness data (jnewbery)
