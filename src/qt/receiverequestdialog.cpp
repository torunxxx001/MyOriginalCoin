...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMyOriginalCoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MyOriginalCoinUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMyOriginalCoinURI(info));
}
