...
/** MyOriginalCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MyOriginalCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MyOriginalCoinUnits(QObject *parent);

    /** MyOriginalCoin units.
...
typedef MyOriginalCoinUnits::Unit MyOriginalCoinUnit;
