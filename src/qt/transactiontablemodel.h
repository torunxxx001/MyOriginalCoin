...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, MyOriginalCoinUnits::SeparatorStyle separators=MyOriginalCoinUnits::separatorStandard) const;
