    ...
    mapper(0)
{
    ...
    ui->openMyOriginalCoinConfButton->setToolTip(ui->openMyOriginalCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new MyOriginalCoinUnits(this));
...
void OptionsDialog::on_openMyOriginalCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openMyOriginalCoinConf())
