...
class RawTransactionsTest(MyOriginalCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid MyOriginalCoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
