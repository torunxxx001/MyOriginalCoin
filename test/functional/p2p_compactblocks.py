...
# TestP2PConn: A peer we use to send messages to myoriginalcoind, and store responses.
...
class CompactBlocksTest(MyOriginalCoinTestFramework):
    ...
    # This test actually causes myoriginalcoind to (reasonably!) disconnect us, so do this last.
    ...
    # myoriginalcoind's choice of nonce.
    ...
    # Test that myoriginalcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for myoriginalcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # myoriginalcoind will not send blocktxn responses for blocks whose height is
