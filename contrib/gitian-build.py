...
def setup():
    ...
    if not os.path.isdir('bitcoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/torunxxx001/MyOriginalCoin.git'])
...
def build():
    ...
    subprocess.check_call(['wget', '-N', '-P', 'inputs', 'https://github.com/torunxxx001/cfields/osslsigncode-Backports-to-1.7.1.patch'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/torunxxx001/MyOriginalCoin', help='Specify the URL of the repository. Default is %(default)s')
